...
<%
	...
	try {
		...
		String emp_list = request.getAttribute("GRADE_LIST").toString();
		...
		<div class="page-container" style="padding-left: 0px;">
			...
			<div class="main-content">
				<div class="page-header">
					<h2 class="header-title">Grade Master</h2>
					<div class="header-sub-title">
						<nav class="breadcrumb breadcrumb-dash">
							<a href="#" class="breadcrumb-item"><i
								...
								class="breadcrumb-item active">Grade Master</span>
						</nav>
					</div>
				</div>
				<div class="card">
					<div class="card-body">
						<h4>Grade Master</h4>
						<% 
						    if("Y".equalsIgnoreCase(GetMenu.GetSubDetailsMenuCreate(jmenu,"HRMS","HR_MANGE","GRADE_MST")))
							{
						%>
								<p align="right"><button class="btn btn-primary" onclick="onloadpage('GRADE_MST')">
									<i class="anticon anticon-plus"></i>
									<span class="m-l-5">New Grade</span>
								</button></p>
						<%   
							}else{
						%>
								...
								<tbody>
									...
									<%
													...
													for (int i = 0; i < jResponse.length(); i++) {
														...
														if("Y".equalsIgnoreCase(GetMenu.GetSubDetailsMenuUpdate(jmenu,"HRMS","HR_MANGE","GRADE_MST")))
														{
														...
														if("Y".equalsIgnoreCase(GetMenu.GetSubDetailsMenuDelete(jmenu,"HRMS","HR_MANGE","GRADE_MST")))
														{
...
function of_delete_emp(thisval,user_id)
{
	...
	showConfirmMessage("Delete?","Are you sure to delete this Grade?","DELETE",user_id);
}
function onconfirm(req_url,req_data)
{
	var data={"action_id":req_url,"grade_id":req_data};
	showLoaderPage(true);
	CallAPI("grade_master",data,onSuccessContraMst,onErrorResponse);	
}
...
{   
	...
	if (data != "") 
	{
         ...
         if (res.STATUS_CD == "0") {
        	 if(res.ACTION == "E")
             {
        		 onloadpage('GRADE_MST');
             }
        	 else{
        		 var row = $("#dlt_"+res.GRADE_ID).closest('tr');
