...
<%
	...
	try {
		...
		String emp_list = GetSession.getSessionString("INSU_LIST");
		...
		<div class="page-container" style="padding-left: 0px;">
			...
			<div class="main-content">
				<div class="page-header">
					<h2 class="header-title">Insurance Master</h2>
					<div class="header-sub-title">
						<nav class="breadcrumb breadcrumb-dash">
							<a href="#" class="breadcrumb-item"><i
								...
								class="breadcrumb-item active">Insurance Management</span>
						</nav>
					</div>
				</div>
				<div class="card">
					<div class="card-body">
						...
						<% 
						    if("Y".equalsIgnoreCase(GetMenu.GetSubDetailsMenuCreate(jmenu,"HRMS","HR_MANGE","INSU_MST")))
							{
						%>
								<p align="right"><button class="btn btn-primary" onclick="onloadpage('INSU_MST')">
									<i class="anticon anticon-plus"></i>
									<span class="m-l-5">New Insurance</span>
								</button></p>
						<%   
							}else{
						%>
								...
								<tbody>
									...
									<%
													...
													for (int i = 0; i < jResponse.length(); i++) {
														...
														user_id=jobj1.getString("INSU_ID");
														tableData = "<tr>";
														tableData = tableData + "<td>"+user_id+"</td>";
														tableData = tableData + "<td>"+jobj1.getString("INSU_NAME")+"</td>";
														tableData = tableData + "<td>"+jobj1.getString("INSU_AGENCY")+"</td>";
														tableData = tableData + "<td>"+jobj1.getString("INSU_PREMIUM")+"</td>";
														tableData = tableData + "<td>"+jobj1.getString("INSU_START_DT")+"</td>";
														tableData = tableData + "<td>"+jobj1.getString("INSU_END_DT")+"</td>";
														
														if(jobj1.getString("INSU_STATUS").equalsIgnoreCase("Y"))
														...
														if("Y".equalsIgnoreCase(GetMenu.GetSubDetailsMenuUpdate(jmenu,"HRMS","HR_MANGE","INSU_MST")))
														{
														...
														if("Y".equalsIgnoreCase(GetMenu.GetSubDetailsMenuDelete(jmenu,"HRMS","HR_MANGE","INSU_MST")))
														{
...
function of_delete_emp(thisval,user_id)
{
	...
	showConfirmMessage("Delete?","Are you sure to delete this Insurance?","DELETE",user_id);
}
function onconfirm(req_url,req_data)
{
	var data={"action_id":req_url,"insu_id":req_data};
	showLoaderPage(true);
	CallAPI("insu_master",data,onSuccessInsuMst,onErrorResponse);	
}
function onSuccessInsuMst(data, textStatus, jqXHR)
{   
	...
	if (data != "") 
	{
         ...
         if (res.STATUS_CD == "0") {
        	 if(res.ACTION == "E")
             {
        		 ...
        		 var row = $("#dlt_"+res.INSU_ID).closest('tr');
