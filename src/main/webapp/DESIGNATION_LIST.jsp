...
<%
	...
	try {
		...
		String emp_list = request.getAttribute("DESIGNATION_LIST").toString();
		...
		<div class="page-container" style="padding-left: 0px;">
			...
			<div class="main-content">
				<div class="page-header">
					<h2 class="header-title">Designation Master</h2>
					<div class="header-sub-title">
						<nav class="breadcrumb breadcrumb-dash">
							<a href="#" class="breadcrumb-item"><i
								...
								class="breadcrumb-item active">Designation Master</span>
						</nav>
					</div>
				</div>
				<div class="card">
					<div class="card-body">
						<h4>Shift Master</h4>
						<% 
						    if("Y".equalsIgnoreCase(GetMenu.GetSubDetailsMenuCreate(jmenu,"HRMS","HR_MANGE","DESDIG_MST")))
							{
						%>
								<p align="right"><button class="btn btn-primary" onclick="onloadpage('DESIGNATION_MST')">
									<i class="anticon anticon-plus"></i>
									<span class="m-l-5">New Designation</span>
								</button></p>
						<%   
							}else{
						%>
								...
								<tbody>
									...
									<%
													...
													for (int i = 0; i < jResponse.length(); i++) {
														...
														user_id=jobj1.getString("DESIG_ID");
														tableData = "<tr>";
														tableData = tableData + "<td>"+user_id+"</td>";
														tableData = tableData + "<td>"+jobj1.getString("NAME")+"</td>";
														tableData = tableData + "<td>"+jobj1.getString("DEPART_ID")+"</td>";
														...
														if("Y".equalsIgnoreCase(GetMenu.GetSubDetailsMenuUpdate(jmenu,"HRMS","HR_MANGE","DESDIG_MST")))
														{
														...
														if("Y".equalsIgnoreCase(GetMenu.GetSubDetailsMenuDelete(jmenu,"HRMS","HR_MANGE","DESDIG_MST")))
														{
									...
									<%
											...
											System.out.println("Error in Set Designation List : " + e);
...
function of_delete_emp(thisval,user_id)
{
	...
	showConfirmMessage("Delete?","Are you sure to delete this Designation?","DELETE",user_id);
}
function onconfirm(req_url,req_data)
{
	var data={"action_id":req_url,"desig_id":req_data};
	showLoaderPage(true);
	CallAPI("designation_master",data,onSuccessShiftMst,onErrorResponse);	
}
...
{   
	...
	if (data != "") 
	{
         ...
         if (res.STATUS_CD == "0") {
        	 if(res.ACTION == "E")
             {
        		 onloadpage('DESIGNATION_MST');
             }
        	 else{
        		 var row = $("#dlt_"+res.DESIGNATION_ID).closest('tr');
