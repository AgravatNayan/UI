...
<%
	...
	try {
		...
		String emp_list = request.getAttribute("SHIFT_LIST").toString();
		...
		<div class="page-container" style="padding-left: 0px;">
			...
			<div class="main-content">
				<div class="page-header">
					<h2 class="header-title">Shift Master</h2>
					<div class="header-sub-title">
						<nav class="breadcrumb breadcrumb-dash">
							<a href="#" class="breadcrumb-item"><i
								...
								class="breadcrumb-item active">Shift Master</span>
						</nav>
					</div>
				</div>
				<div class="card">
					<div class="card-body">
						<h4>Shift Master</h4>
						<% 
						    if("Y".equalsIgnoreCase(GetMenu.GetSubDetailsMenuCreate(jmenu,"HRMS","HR_MANGE","SHIFT_MST")))
							{
						%>
								<p align="right"><button class="btn btn-primary" onclick="onloadpage('SHIFT_MST')">
									<i class="anticon anticon-plus"></i>
									<span class="m-l-5">New Shift</span>
								</button></p>
						<%   
							}else{
						%>
								...
								<tbody>
									...
									<%
													...
													for (int i = 0; i < jResponse.length(); i++) {
														...
														user_id=jobj1.getString("SHIFT_ID");
														tableData = "<tr>";
														tableData = tableData + "<td>"+user_id+"</td>";
														tableData = tableData + "<td>"+jobj1.getString("SHIFT_NAME")+"</td>";
														tableData = tableData + "<td>"+jobj1.getString("SHIFT_START_TIME")+"</td>";
														tableData = tableData + "<td>"+jobj1.getString("SHIFT_END_TIME")+"</td>";
														
														if(jobj1.getString("SHIFT_STATUS").equalsIgnoreCase("Y"))
														...
														if("Y".equalsIgnoreCase(GetMenu.GetSubDetailsMenuUpdate(jmenu,"HRMS","HR_MANGE","SHIFT_MST")))
														{
														...
														if("Y".equalsIgnoreCase(GetMenu.GetSubDetailsMenuDelete(jmenu,"HRMS","HR_MANGE","SHIFT_MST")))
														{
...
function of_delete_emp(thisval,user_id)
{
	...
	showConfirmMessage("Delete?","Are you sure to delete this Shift?","DELETE",user_id);
}
function onconfirm(req_url,req_data)
{
	var data={"action_id":req_url,"shift_id":req_data};
	showLoaderPage(true);
	CallAPI("shift_master",data,onSuccessShiftMst,onErrorResponse);	
}
function onSuccessShiftMst(data, textStatus, jqXHR)
{   
	...
	if (data != "") 
	{
         ...
         if (res.STATUS_CD == "0") {
        	 if(res.ACTION == "E")
             {
        		 onloadpage('SHIFT_MST');
             }
        	 else{
        		 var row = $("#dlt_"+res.SHIFT_ID).closest('tr');
